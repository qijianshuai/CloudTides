...
export declare class CdsTreeItem extends LitElement implements Animatable {
    ...
    protected ariaDisabled: AriaBooleanAttributeValues | undefined;
    protected ariaExpanded: AriaBooleanAttributeValues | undefined;
    protected ariaSelected: AriaBooleanAttributeValues | undefined;
    multiSelect: boolean;
    disabled: boolean;
    expanded: boolean;
    expandable: boolean;
